create table `water_gauge` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '水表主键ID',
  `no` varchar(64) COLLATE utf8_bin DEFAULT NULL COMMENT '水表编号',
  `community_id` int(11) DEFAULT NULL COMMENT '社区ID',
  `type` tinyint(4) DEFAULT NULL COMMENT '水表类型:1-住户，2-商铺，3-公摊',
  `num` float(12,5) DEFAULT NULL COMMENT '水表读数',
