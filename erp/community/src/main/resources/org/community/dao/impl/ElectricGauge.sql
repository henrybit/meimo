create table `electric_gauge` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '电表主键ID',
  `no` varchar(64) COLLATE utf8_bin DEFAULT NULL COMMENT '电表编号',
  `community_id` int(11) DEFAULT NULL COMMENT '社区ID',
  `type` tinyint(4) DEFAULT NULL COMMENT '电表类型:1-住户，2-商铺，3-公摊',
  `num` float(12,5) DEFAULT NULL COMMENT '电表读数',
